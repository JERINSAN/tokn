    ...
    return(<>
        <div className='footer-wrap '>
            ...
            <div className='footer-part-2 footer-part'>
                <a href='#' className='footer-link-title'>About</a>
                <a href='#' className='footer-link'>What is Tokn?</a>
                <a href='#' className='footer-link'>Why Tokn exists</a>
            </div>

            <div className='footer-part-3 footer-part'>
                <a href='#' className='footer-link-title'>Tipper</a>
                <a href='#' className='footer-link'>Our Portfolio</a>
                <a href='#' className='footer-link'>Lastest Work</a>
                <a href='#' className='footer-link'>Brands</a>
                
            </div>

            <div className='footer-part-4 footer-part'>
                <a href='#' className='footer-link-title'>Merchant</a>
                <a href='#' className='footer-link'>Why partner with Tokn?</a>
                <a href='#' className='footer-link'>Showcase visibility & branding benefits</a>
                <a href='#' className='footer-link'>How to register</a>
            </div>
            <div className='footer-part-5 footer-part'>
                <a href='#' className='footer-link-title'>Features</a>
            ...
            <div className='footer-part-6 footer-part'>
                <a href='#' className='footer-link-title'>Legal</a>
